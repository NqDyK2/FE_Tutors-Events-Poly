...
const AppFooter = () => {
  return <Footer className='tw-bg-white dark:tw-bg-[#1E2139]'>
    <div className='tw-flex tw-bg-white dark:tw-bg-[#1E2139] dark:tw-text-slate-300'>
      ...
      <div className='tw-w-[65%] tw-border-l-2 tw-border-black dark:tw-border-l-white tw-pl-[15px]'>
        <h5 className='tw-text-[16px] tw-font-bold dark:tw-text-slate-300 '>Thông tin liên hệ</h5>
        <div>
          <div className='tw-flex'>
            <RiPhoneFill size={16} />
            <span className='tw-text-[12px] tw-pl-[4px] '>
              Số điện thoại liên hệ giải đáp ý kiến sinh viên:
              <Link to='#' className='tw-text-black tw-text-[12px] tw-font-bold tw-pl-[2px] dark:tw-text-slate-300' >
                0123456789
              </Link>
            </span>
          </div>
            ...
            <span className='tw-text-[12px] tw-pl-[4px]'>
              ...
              <ul className='tw-pl-6 tw-list-disc'>
                <li>Phòng dịch vụ sinh viên:
                  <Link to='#' className='tw-font-bold tw-text-black tw-pl-[4px] dark:tw-text-slate-300' >dvsvpoly.hn@poly.edu.vn</Link>
                </li>
                <li>
                ...
                <li>
                  Phòng hành chính:
                  <Link to='#' className='tw-font-bold tw-text-black tw-pl-[4px] dark:tw-text-slate-300'>
